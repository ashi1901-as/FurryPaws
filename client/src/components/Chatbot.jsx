...
export default function Chatbot({ onClose }) {
  ...
  const faq = {
     // New section for greetings
    "hi": "Hello! How can I assist you with your pet today?",
    ...
    "can dogs eat eggs":
      "Yes, cooked eggs are a good protein source.",
    "can dogs eat bread":
      "Plain bread is safe in small amounts but not nutritious.",
    "can dogs eat peanut butter":
      "Yes, as long as it does not contain xylitol, which is toxic.",
    "can cats eat cheese":
      "Most cats are lactose intolerant, so avoid cheese.",
    "can dogs eat apples":
      "Yes, remove seeds and core before feeding apples.",
    "can dogs eat grapes":
